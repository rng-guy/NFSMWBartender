...
* You can disable any feature of this set by deleting its parameter group or the file containing it. This does not apply to the engagement-count fix, however: it is tied to this feature set.
