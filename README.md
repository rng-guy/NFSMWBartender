...
* You can disable any feature of this set by deleting its parameter group or the file containing it. This does not apply to the engagement-count fix, which is tied to this entire feature set.
