...
Both feature sets of this mod should be compatible with all VltEd, Binary, and most .asi mods. Any known and notable exceptions to this are explicitly mentioned in this section.
