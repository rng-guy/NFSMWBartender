...
Some PARAMETER GROUPS (indicated by "[GroupName]") in Bartender's configuration files allow you
to provide a "default" value. For each parameter group, a comment in the relevant file states
